...
hi LineNr               cterm=none ctermbg=none     ctermfg=7       gui=none        guibg=#272727   guifg=#8F8F8F
hi StatusLine           cterm=none ctermbg=7        ctermfg=15      gui=none        guibg=#5D5D5D   guifg=#FBFBFB
hi StatusLineNC         cterm=none ctermbg=15       ctermfg=7       gui=none        guibg=#5D5D5D   guifg=#FBFBFB
hi Search               cterm=none ctermbg=6        ctermfg=8
...
hi NonText              cterm=bold ctermbg=none     ctermfg=7       gui=bold guifg=#898989 guibg=#060606
hi ModeMsg              cterm=bold ctermbg=none     ctermfg=10
hi Pmenu                cterm=none ctermbg=7        ctermfg=15
...
hi Identifier           cterm=none ctermbg=none ctermfg=4           gui=none        guifg=#96D9F1
...
hi Constant             cterm=none ctermbg=none ctermfg=4           gui=none        guifg=#96D9F1
hi PreProc              cterm=none ctermbg=none ctermfg=10          gui=none        guifg=#D1FA71
hi Type                 cterm=none ctermbg=none ctermfg=4           gui=none        guifg=#96D9F1
